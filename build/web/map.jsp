<%-- 
    Document   : map
    Created on : Apr 5, 2016, 6:38:26 AM
...
<head>
  ...
  <title>Easy Water Supply| Map </title>
    ...
    <div class="main_container" style="background-color: #2A3F54;">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section" >
              <ul class="nav side-menu" style="padding-top:65px;">
                <li><a href="djb.jsp"><i class="fa fa-home"></i> Dashboard </a></li>
      ...
      <body data-twttr-rendered="true">
        ...
        <body data-twttr-rendered="true">
          ...
          <script type="text/javascript">
            ...
            function initialize() {
              var data = {
                "count": 5,
                "photos": [{
                  "longitude": "77.1634092",
                  "latitude": "28.5664536",
                  "created_by": "AIM Testing5",
                  "created_date": "2016-3-26 17:02:18",
                  "msisdn": "255759121175",
                  "registrant": "House 1"
                }, {
                  "longitude": "77.16598928",
                  "latitude": "28.63008181",
                  "created_by": "AIM Testing5",
          ...
          <div id="map-container" style="height:600px;width:990px;margin-left:230px">
            <div id="map"></div>
          </div>
